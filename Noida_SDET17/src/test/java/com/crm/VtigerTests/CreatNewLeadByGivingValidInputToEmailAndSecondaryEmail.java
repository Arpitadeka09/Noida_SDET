...
public class CreatNewLeadByGivingValidInputToEmailAndSecondaryEmail {
	@Test
	public void Lead15() throws Throwable {
WebDriverUtility wUtil=new WebDriverUtility();
		...
		driver.findElement(By.xpath("//img[@src='themes/softed/images/btnL3Add.gif']")).click();
		 ...
		 WebElement sarname = driver.findElement(By.name("salutationtype"));
	        ...
	        secondaryemail.sendKeys("sambit.17@gmail.com");
	        ...
	        Email.sendKeys("sweetarpita91@gmail.com,");
