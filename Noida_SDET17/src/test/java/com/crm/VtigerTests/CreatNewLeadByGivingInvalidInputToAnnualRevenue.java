...
public class CreatNewLeadByGivingInvalidInputToAnnualRevenue {
	@Test
	
	public void leadTC12() throws Throwable {
		...
		//Enter  invalid input to "Annual Revenue" and fill rest of the fields and click on "Save" button
